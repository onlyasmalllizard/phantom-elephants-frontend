      ...
      <main>
        ...
        >
          <div
            ...
            style={{
              backgroundImage:
                "url('https://www.schoolofcode.co.uk/static/fd89c2e08a63097c51e92eb36c819742/cc870/workshops_noFade.webp')",
            }}
          >
            <span
              id="blackOverlay"
          ...
          <div className="container relative mx-auto">
            <div className="items-center flex flex-wrap">
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-white font-semibold text-5xl">Demeter</h1>
          ...
          <div className="container mx-auto px-4">
              ...
              <div className="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Monitor Progress</h6>
                    <p className="mt-2 mb-4 text-gray-600">
                      Follow and track your student's progress throughout their
              ...
              <div className="w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <h6 className="text-xl font-semibold">Spot Trends</h6>
                    <p className="mt-2 mb-4 text-gray-600">
                      Use data analysis to spot any trends or concerns in your
                      student's progress
                    </p>
                  </div>
                </div>
              ...
              <div className="pt-6 w-full md:w-4/12 px-4 text-center">
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                  <div className="px-4 py-5 flex-auto">
                    ...
                    <p className="mt-2 mb-4 text-gray-600">
                      All student data is collated and can be accessed under one
                      platform.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-wrap items-center mt-32">
              ...
              <div className="w-full md:w-4/12 px-4 mr-auto ml-auto">
                <div className="relative flex  min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-pink-600">
                  <img
                    alt="..."
                    src="https://media-exp1.licdn.com/dms/image/C4D22AQEqm-kRpKakoA/feedshare-shrink_800/0/1629890056744?e=1639008000&v=beta&t=U6cBSyVAVFOd10hlIFDy5dBsBu3WpYDIjn5gnXLFn0M"
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full md:w-4/12 ml-auto mr-auto px-4">
                <img
                  ...
                  src="https://www.schoolofcode.co.uk/static/0ee21a2e72825663a2e8f823ca983ae9/60b4e/energisers2.webp"
                />
              </div>
